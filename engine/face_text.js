...
export const JA = {
  ...
  hair: { hair01_buzz:'坊主', hair02_softmohawk:'ソフトモヒカン',
    ...
    hair31_flowbang:'流し前髪のショート',
    hair32_upfade:'かき上げのツーブロック',
    hair33_roundmush:'丸みのあるマッシュ',
    hair34_sidepomade:'七三のポマード',
    hair35_messyshort:'無造作なショート' },
...
const M = {
  ...
  hair: {
    ...
    hair31_flowbang: ['短髪', '斜めに流した前髪（左流し）', 'ワックスの束感セット'],
    hair32_upfade: ['ソフトツーブロック', 'かき上げ風前髪', 'ワックスの束感セット'],
    hair33_roundmush: ['マッシュ', '眉にかかる重め前髪', 'ツヤを抑えたナチュラルセット'],
    hair34_sidepomade: ['ビジネス短髪', '斜めに流した前髪（左流し）', 'きっちり撫でつけたセット'],
    hair35_messyshort: ['短髪', '軽く上げた前髪', '無造作セット'],
  },
